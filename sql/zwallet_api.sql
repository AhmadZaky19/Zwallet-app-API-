...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 10, 2020 at 10:08 AM
...
CREATE TABLE `tb_balance` (
  ...
  `balance` int(10) NOT NULL DEFAULT 20000
...
(59, NULL, 'Top Up', 'in', 25, 2000000, '2020-11-09 12:01:53', 'Modal'),
(60, 25, 'Transfer', 'out', 23, 10000, '2020-11-09 12:27:41', 'Tes'),
(61, 25, 'Transfer', 'out', 23, 123456, '2020-11-09 12:29:13', NULL),
(62, 25, 'Transfer', 'out', 20, 12000, '2020-11-09 12:31:25', NULL),
(63, 25, 'Transfer', 'out', 20, 1400, '2020-11-09 12:32:01', NULL),
(64, 26, 'Transfer', 'out', 25, 1200, '2020-11-09 12:41:27', NULL),
(65, 25, 'Transfer', 'out', 26, 2000, '2020-11-09 17:16:57', 'Qwerty'),
(66, 25, 'Transfer', 'out', 21, 3000, '2020-11-09 17:32:45', NULL),
(67, 25, 'Transfer', 'out', 22, 3000, '2020-11-09 17:33:19', NULL);
...
(21, 'Lecrec', 'lenade@gmail.com', '$2b$10$H5kTAV9xH6lq2yLtKGGB5ucU1K431BjDjaUZmYo1B05fYSoQWqVDu', 123456),
(22, 'Arya', 'arya@mail.com', '$2b$10$cYlP7iezClB4U0FL2OyPReGZZdeRO9jFDi4TAfnubQFYJ1j9QFjpO', 222222),
(23, 'Hakan', 'robert@mail.com', '$2b$10$5fbnmasVcqRBvQ112Vv6Y.hjzblBv./GjXwK4.fa/4Ud73Z8parUe', 222222),
(24, 'sapi', 'sapi@gmail.com', 'Sapi1234', 111111),
(25, 'Ahmad Zaky', 'a.zaky32@gmail.com', '$2b$10$gRWyoInewNHfpVfM/PxY0ewAI8jWdCoMrmKJdVUAW.MxWpBa4L1J.', 123456),
(26, 'Fajar Satria', 'fajarsatria289@gmail.com', '$2b$10$tY2Uvl/P8hSvj7JEy/xK2.KcOMy6W/M/pip0qiZRI55h8Mk.LACVq', 654321);
...
(25, 'Ahmad Zaky', NULL, '+6282281282821', '/images/1604942575394.jpg'),
(26, 'Fajar Satria', NULL, '+6285368720606', '/images/1604925754087.jpg');
...
--
ALTER TABLE `tb_transaction`
  MODIFY `transaction_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
